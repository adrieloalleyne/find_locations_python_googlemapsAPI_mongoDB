findLocations Module Documentation
...
getLocations takes a list of keyword arguments, with a start and destination address, a url for a mongo instance and an optional name for the new route as arguments. Get locations will return a 
